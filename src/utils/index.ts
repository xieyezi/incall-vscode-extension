...
const generateStatusBar = (text: string, command: string) => {
	...
	button.text = text;
	button.tooltip = 'Generate new incall package from xieyezi.';
	button.color = '#fdcb6e';
...
// 输入packageName
const promptForPackageName = (): Thenable<string | undefined> => {
...
export { generateStatusBar, promptForPackageName, toBigHump, toBottomLine, makeDirSync, writeFileSync };
